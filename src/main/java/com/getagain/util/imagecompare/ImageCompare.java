...
import com.sun.image.codec.jpeg.*;
 ...
 public class ImageCompare {
	...
	public static void main(String[] args) {
		...
		ImageCompare ic = new ImageCompare("E:\\HtmlReview1\\test3\\rch_sb_B1_041.pdf_font.jpg", "E:\\HtmlReview1\\test3\\rch_sb_B1_041.pdf_image.jpg");
		// Set the comparison parameters. 
		//   (num vertical regions, num horizontal regions, sensitivity, stabilizer)
		ic.setParameters(18, 16, 10, 10);
