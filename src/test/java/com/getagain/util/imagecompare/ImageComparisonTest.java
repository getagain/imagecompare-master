...
public class ImageComparisonTest {
    ...
    String googleReference = "C:/work/HtmlReview/test9/imgtest/CHROME_LOCALWINDOWS_srd_topband_container.png";
    //private static final 
    String googleIdentical = "C:/work/HtmlReview/test9/imgtest/FIREFOX_LOCALWINDOWS_srd_topband_container.png";

  
    
    @Test
    public final void checkImageComparisonWithIdenticalImages() throws IOException {
...
/*        
        System.out.println(googleIdentical);   
        final boolean result1 = imageComparisonService.compare(googleIdenticalImage, googleIdenticalImage);
        System.out.println("Calculated percentage of equality is:"+SimpleImageComparisonProcessor.getpercentEquality());
        String perc2=""+ SimpleImageComparisonProcessor.getpercentEquality();
		values.add(new String[] { googleIdentical, perc2 });
*/
		try {
